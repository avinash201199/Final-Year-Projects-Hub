    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl font-bold mb-6 text-balance">About Final Year Projects Hub</h1>
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <h2 className="text-3xl font-bold mb-6 mt-12">Meet the Creator</h2>
            <div className="not-prose bg-card border border-border rounded-lg p-8 mb-8">
